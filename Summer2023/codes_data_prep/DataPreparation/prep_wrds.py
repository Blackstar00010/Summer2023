...
if __name__ == "__main__":
    ...
    organize_secd = True
    if organize_secd:
        # gvkey,datadate,conm,isin,exchg,monthend,curcdd,ajexdi,cshoc,cshtrd,qunit,
        ...
        price_col_list = ['prccd', 'prchd', 'prcld', 'prcod']

        comp_secd[price_col_list] = comp_secd[price_col_list].replace(0, float('NaN'))
        comp_secd[price_col_list] = comp_secd[price_col_list].multiply(1 / comp_secd['qunit'].replace(float('NaN'), 1),
                                                                       axis=0)
        comp_secd[price_col_list] = comp_secd[price_col_list].multiply(1 / comp_secd['ajexdi'].replace(float('NaN'), 1),
                                                                       axis=0)
