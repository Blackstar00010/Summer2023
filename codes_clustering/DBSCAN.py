...
for i, cluster_label in enumerate(cluster_labels):
    clusters[cluster_label].append(firm_names[i])  # Use actual firm name instead of 'firm {i + 1}'
...
# Define DBSCAN parameters
eps = 80  # Maximum distance between two samples to be considered as neighbors
